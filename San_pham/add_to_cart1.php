...
<?php
   ...
   //mếu có thì vào được trang chủ của khách hàng
   //nếu không thì phải đăng nhập
    if(!isset($_SESSION['taikhoan']) || $_SESSION['taikhoan'] = true){
        echo  "<script>alert('Bạn phải đăng nhập để đặt hàng.');
            window.location='../Dang_nhapuser/loginuser.php';</script>";
      exit;
    }
?>
<!DOCTYPE html>
